...
Next, we'll create a new agent. This agent will have a specific persona that instructs it on how to behave and, most importantly, it will be equipped with our new search tool with dependencies configured programmatically.
...
Your agent is now fully configured! Both the tool dependencies and environment variables are set programmatically.
