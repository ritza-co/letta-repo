...
<Steps>
  ...
  <Step title="Get Your API Key">
    Once logged in, navigate to **Settings** in the sidebar, then click the **API Keys** tab. Click **Create API Key**, give it a name, and copy the key.
...
<Steps>
  ...
  <Step title="Get Your API Key">
    Once logged in, navigate to the **API Keys** section in your dashboard. Create a new API key and copy it (it will start with `z_`).
