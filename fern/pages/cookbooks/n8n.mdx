...
We'll need API keys for Letta and n8n.
...
<Accordion title="Get your n8n Account Ready">
<Steps>
  <Step title="Sign Up for n8n Cloud">
...
<Steps>
  <Step title="Create a New Workflow">
    In n8n, click **Create workflow** or navigate to an existing workflow.
