...
```
Google Sheets (New Ticket) -> Letta Agent (Intelligence Layer) -> Slack (Notification)
```
...
We'll need API keys for Letta and Zapier.
...
<Accordion title="Get your Zapier Account Ready">
<Steps>
  <Step title="Sign Up for Zapier">
...
<Steps>
  <Step title="Add a Webhooks Action">
    ...
    3. Choose action event: **Custom Request**
    4. Click **Continue**
  </Step>
...
Add a test ticket to your Google Sheet:

| Ticket ID | Customer Name | Customer Email | Subject | Description | Priority | Timestamp |
|-----------|---------------|----------------|---------|-------------|----------|-----------|
| 1 | Test User | test@example.com | Cannot access account | Getting an error when logging in | High | 2025-01-15 10:30 AM |
