...
Use `conversation_search` for retrieving what was actually said. Use archival memory for storing distilled facts and knowledge. Learn more in the [archival memory docs](/guides/agents/archival-memory) and [prebuilt tools docs](/guides/agents/prebuilt-tools).
</Accordion>
...
This gives consistent knowledge across all agents in your organization.
</Accordion>
